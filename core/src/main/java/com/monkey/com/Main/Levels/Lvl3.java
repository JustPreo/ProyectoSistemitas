...
public class Lvl3 implements Screen {
    ...
    public void show() {
        ...
        mono = new Mono("Humano/Humano.png", 32, 256, 200, colisiones);
        mono.mejoraMono3();
    ...
    private void miniJuegoCable(RectangleMapObject palancaObj, String target, MapLayer collLayer,
                            TiledMapTileLayer doorLayer, int tileWidth, int tileHeight) {
    if (!enMiniGame) {
        enMiniGame = true;
